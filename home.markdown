**[Version 1.5.3](updates) is now out | [view screenshots](#overview) | [FAQ](FAQ) | [troubleshooting](troubleshooting)**  | [Go on vacation to Holland!](http://balansvakantie.nl)
...
For updates please check [updatelog and how to update](updates). There is a video guide available for the normal installation [here](https://www.youtube.com/watch?v=_Z1VhIo07Xc).
