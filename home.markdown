**[Version 1.5.5](updates) is now out | [view screenshots](#overview) | [FAQ](FAQ) | [troubleshooting](troubleshooting)**  | [API docs](https://gitlab.maikel.pro/maikeldus/WhatsSpy-Public/wikis/data-storage-and-API) | [Searching for a vacation house in Holland?](http://balansvakantie.nl)
