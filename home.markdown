...
## Installling WhatsSpy Public on your Linux distribution (Debian/Ubuntu) / Raspberry Pi
...
* **Normal**: [Setup WhatsSpy Public on a existing Linux distribution (Debian/Ubuntu) / Raspberry Pi](getting-started).
